...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCCVars.TTSVolume, TtsVolumeSlider.Value / 100f * TtsMultiplier); // Stories-TTS
        ...
        private void Reset()
        {
            ...
            TtsVolumeSlider.Value = _cfg.GetCVar(CCCVars.TTSVolume) * 100f / TtsMultiplier; // Stories-TTS
