...
alert-level-blue-announcement = На станции присутствует неизвестная угроза. Службе безопасности разрешено проводить выборочные обыски. Членам экипажа обязаны носить удостоверение личности на виду.
...
alert-level-red-announcement = На станции присутствует известная угроза. Служба безопасности имеет право получить вооружение и расширенный доступ. Экипаж обязан подчиняться правомерным приказам сотрудников Службы Безопасности.
