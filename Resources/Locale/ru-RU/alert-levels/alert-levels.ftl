...
alert-level-tempest = Темпест
alert-level-tempest-announcement = Центральное командование объявило на станции уровень угрозы "Темпест". На станции обнаружены временные аномалии, угрожающие существованию временного потока. Экипажу станции следует не препятствовать работе отправленного отряда.
alert-level-tempest-instructions = Сообщайте о подозрительных временных событиях.
