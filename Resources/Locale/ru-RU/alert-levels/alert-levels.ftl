...
alert-level-blue-announcement = На станции присутствует неизвестная угроза. Службе безопасности разрешено проводить выборочные обыски. Члены экипажа обязаны носить удостоверение личности на виду.
...
alert-level-red-announcement = На станции присутствует известная угроза. Служба безопасности имеет право получить вооружение и расширенный доступ. Гражданские лица обязаны подчиняться правомерным приказам сотрудников Службы Безопасности.
alert-level-red-instructions = Экипаж обязан подчиняться правомерным приказам сотрудников Службы Безопасности. Переключите режим работы своего костюма в режим "Координаты".
