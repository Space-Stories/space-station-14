...
ghost-role-information-kobold-name = Кобольт
...
ghost-role-information-salvage-flesh-name = Аберрантская плоть на обломке
ghost-role-information-salvage-flesh-description = Защитите добычу в обломке!
