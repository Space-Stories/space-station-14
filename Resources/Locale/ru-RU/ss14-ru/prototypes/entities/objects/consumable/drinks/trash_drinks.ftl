...
ent-DrinkCartonBaseEmpty = пустая картонная коробка
    .desc = Пустая картонная коробка.
...
ent-DrinkCartonOrange = бутылка от апельсинового сока
    .desc = { ent-DrinkCartonBaseEmpty.desc }
ent-DrinkCartonTomato = бутылка от томатного сока
    .desc = { ent-DrinkCartonBaseEmpty.desc }
ent-DrinkCartonCream = бутылка от молочных сливок
    .desc = { ent-DrinkCartonBaseEmpty.desc }
ent-DrinkCartonMilk = бутылка от молока
    .desc = { ent-DrinkCartonBaseEmpty.desc }
ent-DrinkCartonSoyMilk = бутылка от соевого молока
    .desc = { ent-DrinkCartonBaseEmpty.desc }
