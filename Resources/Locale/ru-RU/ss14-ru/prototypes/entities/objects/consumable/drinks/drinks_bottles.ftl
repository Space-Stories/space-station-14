...
ent-DrinkEnergyDrinkJug = кувшин энергетика
    .desc = Кувшин "Ред Бул", в котором достаточно кофеина, чтобы убить целую станцию.
ent-CustomDrinkJug = кувшин для напитков
    .desc = Кувшин для хранения напитков, изготовленных на заказ.
