...
ent-MobKobold = кобольд
    .desc = Двоюродные братья разумной расы людей-ящериц, кобольды сливаются с индустриальной плиткой и так же противны, как обезьяны; они готовы вырвать ваши волосы и заколоть вас до смерти.
