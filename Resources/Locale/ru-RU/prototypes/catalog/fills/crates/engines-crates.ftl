...
ent-CrateEngineeringTeslaGenerator = ящик с генератором Теслы
    .desc = Генератор Тесла. Боже, храни тебя.
ent-CrateEngineeringTeslaCoil = ящик с катушками Теслы
    .desc = Катушка Тесла. Притягивает молнию и вырабатывает из нее энергию.
ent-CrateEngineeringTeslaGroundingRod = ящик со стержня заземления Теслы
