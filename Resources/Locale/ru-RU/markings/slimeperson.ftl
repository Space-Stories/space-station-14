...
marking-SlimeGradientLeftFoot-gradient_l_foot = Слаймолюд, Левая ступня (Градиент)
marking-SlimeGradientLeftFoot = Слаймолюд, Левая ступня (Градиент)
marking-SlimeGradientRightFoot-gradient_r_foot = Слаймолюд, Правая ступня (Градиент)
marking-SlimeGradientRightFoot = Слаймолюд, Правая ступня (Градиент)
